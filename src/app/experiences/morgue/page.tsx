            ...
            <div className="lg:col-span-2 order-last lg:order-first">
              ...
              <AnimatedSection delay={0.15}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-[#111827] border-2 border-slate-700 rounded-xl p-6 border-l-4 border-l-emerald-500">
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <AnimatedSection delay={0.3} animation="fadeInUp">
              <div className="bg-[#111827] border-2 border-emerald-500 rounded-xl p-6 h-full border-l-4 border-l-emerald-500 opacity-90">
          ...
          <AnimatedSection delay={0.4}>
            <div className="bg-[#111827] border-2 border-slate-700 rounded-xl p-8 text-center">
