              ...
              <div key={chapter.id} className="flex-1">
                <AnimatedSection delay={idx * 0.15} className="flex flex-col items-center">
                  ...
                  {idx < chapters.length - 1 && (
                    <div className="absolute left-1/2 top-8 w-full h-1 bg-slate-700 transform -translate-x-1/2" />
                  )}
                </AnimatedSection>
              </div>
            ))}
            ...
            {chapters.map((chapter, idx) => (
              <AnimatedSection key={chapter.id} delay={idx * 0.15} animation="scaleIn">
                <Link href={`/experiences/${chapter.id}`} className="group h-full">
                  <div className="bg-[#111827] border-2 border-slate-700 rounded-xl h-full flex flex-col overflow-hidden hover:border-teal-400 hover:-translate-y-1 transition-all">
                    {/* Header with solid color accent */}
                    <div
                      className={`h-1 w-full ${
                        idx === 0 ? "bg-purple-500" : idx === 1 ? "bg-amber-500" : "bg-emerald-500"
                      }`}
                    />
                    ...
                    <div className="flex-1 p-6 flex flex-col">
                      ...
                      {/* Image placeholder */}
                      <div
                        className={`h-40 rounded-lg mb-6 flex items-center justify-center overflow-hidden relative ${
                          idx === 0 ? "bg-purple-900" : idx === 1 ? "bg-amber-900" : "bg-emerald-900"
                        } opacity-20`}
                      >
                      ...
                      {/* Details grid */}
                      <div className="grid grid-cols-3 gap-3 mb-6 pt-4 border-t border-slate-700">
                        <div>
                      ...
                      <div className="flex gap-3">
                        <span className="flex-1 btn btn-primary justify-center text-center">
                          Learn More
                        </span>
                      </div>
                    </div>
      ...
      <section className="section-padding bg-[#111827]">
        <div className="section-container max-w-3xl mx-auto">
          ...
          <AnimatedSection delay={0.1}>
            <div className="bg-[#111827] border-2 border-slate-700 rounded-xl p-6 space-y-8">
